...
const IconStyle = css`
	...
	background-color: ${(props) =>
		props.theme.pages.titlePage.hero.iconBackground};
	cursor: pointer;
	...
	&:hover {
		fill: ${(props) =>
			props.iconstyled === "true"
				...
				: props.theme.pages.titlePage.hero.saveButtons.wantToSee
						.second};
	}
...
export const WatchedIcon = styled(Watched)`
	...
	@media (max-width: 900px) {
		&:hover {
			fill: ${(props) =>
				props.iconstyled === "true"
					? props.theme.pages.titlePage.hero.saveButtons.watched
							.second
					: props.theme.pages.titlePage.hero.saveButtons.watched
							.first};
		}
	...
	@media (max-width: 900px) {
		&:hover {
			fill: ${(props) =>
				props.iconstyled === "true"
					? props.theme.pages.titlePage.hero.saveButtons.loveIt.second
					: props.theme.pages.titlePage.hero.saveButtons.loveIt
							.first};
		}
	}
`;
	...
	@media (max-width: 1000px) {
		& p {
			...
			border: 0.35rem solid
				${(props) => props.theme.pages.titlePage.hero.imdb};
			border-radius: 15rem;
			margin: 0.15rem auto;
		}
...
export const MobileImdbAndSaveListContainer = styled.div`
	...
	height: 4.5rem;
	background-color: ${(props) =>
		props.theme.pages.titlePage.hero.mobileBackground};
...
export const DetailsPanel = styled.div`
	...
	border-left: 0.25rem solid
		${(props) => props.theme.pages.titlePage.content.border};
